...
onMounted(async () => {
  await pocketbase.collection('wrestler').getFirstListItem('id="' + route.params.id + '"', {
    ...
    >
      ...
      <Card>
        ...
        <template #content>
          ...
          <p>Schwingverband: {{ wrestlerData.expand.club.expand.canton.expand.association.name }} ({{ wrestlerData.expand.club.expand.canton.expand.association.abbreviation }})</p>
        </template>
      </Card>
    </div>
